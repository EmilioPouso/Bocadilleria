...
$PRODUCT_ID = "boc-mixto"
$patchPath = Join-Path $PSScriptRoot "patch_boc_mixto.json"
$patchJson = [System.IO.File]::ReadAllText($patchPath)
...
Write-Host "Actualizando $PRODUCT_ID ..."
